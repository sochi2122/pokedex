...
//POST /pokemon
//PUT /pokemon/:id
//DELETE /pokemon/:idapp.delete('/pokemon/:id', (req, res) => {    pokemon.splice(req.params.id, 1); //remove the item from the array    res.redirect('/pokemon'); //redirect back to index route  });
